...
namespace HabitatArchuleta\Core;
use HabitatArchuleta\Utility;
 ...
 * If you're building a theme based on "habitat-archuleta", change the
 * filename of '/languages/HabitatArchuleta.pot' to the name of your project.
 *
 * @return void
 */
function i18n() {
	load_theme_textdomain( 'habitat-archuleta', HABITAT_ARCHULETA_PATH . '/languages' );
}
...
function scripts() {
	...
	wp_enqueue_script(
		'frontend',
		HABITAT_ARCHULETA_TEMPLATE_URL . '/dist/js/frontend.js',
...
function styles() {
	...
	wp_enqueue_style(
		'styles',
		HABITAT_ARCHULETA_TEMPLATE_URL . '/dist/css/style.css',
		[],
...
function add_manifest() {
	echo "<link rel='manifest' href='" . esc_url( HABITAT_ARCHULETA_TEMPLATE_URL . '/manifest.json' ) . "' />";
}
